package com.ucare.webucare.model.cep;
...
public class ViaCEP extends ViaCEPBase {
     ...
     * @param events eventos para a classe
     * @param cep
     * @throws com.ucare.webucare.model.cep.ViaCEPException ocorra algum erro
     */
    public ViaCEP(String cep, ViaCEPEvents events) throws ViaCEPException, JSONException {
        super();
        this.Events = events;
        this.buscar(cep);
    }
     ...
     *
     * @param cep
     * @throws com.ucare.webucare.model.cep.ViaCEPException caso ocorra algum erro
     */
     ...
     */
    @Override
    public void buscarCEP(CEP cep) throws ViaCEPException, JSONException {
     ...
     */
    @Override
    public void buscarCEP(String Uf, String Localidade, String Logradouro) throws ViaCEPException, JSONException {
        // define o cep atual
        currentCEP = "?????-???";
