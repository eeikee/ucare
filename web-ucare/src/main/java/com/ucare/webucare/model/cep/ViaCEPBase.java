...
public abstract class ViaCEPBase {
    ...
    // métodos abstratos
    public abstract void buscar(String cep) throws ViaCEPException, JSONException;
    public abstract void buscarCEP(CEP cep) throws ViaCEPException, JSONException;
     ...
     * @throws com.ucare.webucare.model.cep.ViaCEPException
     */
